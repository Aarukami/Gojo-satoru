...
import KazutoraAnimeBot.modules.sql.notes_sql as sql
from KazutoraAnimeBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from KazutoraAnimeBot.__main__ import DATA_IMPORT
from KazutoraAnimeBot.modules.helper_funcs.chat_status import user_admin
from KazutoraAnimeBot.modules.helper_funcs.alternate import typing_action

# from KazutoraAnimeBot.modules.rules import get_rules
import KazutoraAnimeBot.modules.sql.rules_sql as rulessql

# from KazutoraAnimeBot.modules.sql import warns_sql as warnssql
import KazutoraAnimeBot.modules.sql.blacklist_sql as blacklistsql
from KazutoraAnimeBot.modules.sql import disable_sql as disabledsql

# from KazutoraAnimeBot.modules.sql import cust_filters_sql as filtersql
# import KazutoraAnimeBot.modules.sql.welcome_sql as welcsql
import KazutoraAnimeBot.modules.sql.locks_sql as locksql
from KazutoraAnimeBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("KazutoraAnimeBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("KazutoraAnimeBot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `KazutoraAnimeBot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("KazutoraAnimeBot{}.backup".format(chat_id))  # Cleaning file
