...
from KazutoraAnimeBot.modules.helper_funcs.msg_types import Types
from KazutoraAnimeBot.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    "{first} babe is here!",  #Discord welcome messages copied
