...
from KazutoraAnimeBot.modules import ALL_MODULES
from KazutoraAnimeBot.modules.helper_funcs.chat_status import is_user_admin
from KazutoraAnimeBot.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
 Hey There, I'm [Kazutora](https://te.legra.ph/file/b0ca8129821eb139fad8f.jpg)
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕ Add Me", url="t.me/KazutoraXRobot?startgroup=true"),    
        InlineKeyboardButton(
    ...
    [      
          InlineKeyboardButton(
            text="🗣️ Support", url="https://t.me/kazutorasupport"),
          InlineKeyboardButton(
            text="📁 Source", url="https://github.com/Aarukami/Kazutora",
...
HELP_STRINGS = """
Hey there, I'm Kazutora hanemiya!
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KazutoraAnimmeBot.modules." + module_name)
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "[I am now online!](https://te.legra.ph/file/0cb31940d74a382e93032.jpg)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Kazutora is now alive and functioning")
